...
| K — simultaneous languages (Issues #27, #28) | Dynamic Source & Target language pairing, modular language registry, multi-language NLLB/OPUS & XTTS-v2 | Bidirectional & cross-language switching verified during active call without restart | TR/EN/FR registry shipped 2026-09-06: OPUS tr↔en and tr→fr pinned, NLLB-200 covers remaining pairs; live switching unit/integration tested |
...
| ISSUE-28 | https://github.com/onurozkir/speech-to-translate-en-tr/issues/28 | current | resolved 2026-09-06 | Declarative `[languages]` registry, `/api/languages`, `download_models.py --lang`, XTTS matrix gate |
